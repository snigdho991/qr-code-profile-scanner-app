        ...
        <nav class="navbar navbar-expand-lg bg-custom bg-gradient navigation fixed-top sticky">
            <div class="container">
                <a class="navbar-logo" href="{{ url('/') }}">
                    <img src="{{ config('core.image.default.logo') }}" class="editPro" alt="" height="38">
                </a>
                ...
                <div class="collapse navbar-collapse" id="topnav-menu-content">
                    <ul class="navbar-nav ms-auto" id="topnav-menu" >
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('frontend.about') }}"><span class="cus-style-nav @if(url()->full() == route('frontend.about')) activate @endif">About</span></a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('frontend.faq') }}"><span class="cus-style-nav @if(url()->full() == route('frontend.faq')) activate @endif">FAQs</span></a>
                        </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="mb-4">
                            ...
                            <img src="{{ config('core.image.default.logo') }}" style="background: #fff;border-radius: 2px;" class="editPro" alt="" height="30">
                        </div>

        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('dashboard') }}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ config('core.image.default.logo') }}" style="background: #fff;border-radius: 2px;" class="editPro" alt="" height="25">
                    </span>
                </a>
            ...
            <div class="dropdown d-inline-block">
                ...
                @if(Auth::check())
                    ...
                    @if($user->profile_photo_path != null)
                        <img class="rounded-circle header-profile-user" src="{{ asset('assets/uploads/users/profile/'.$user->profile_photo_path) }}"
                            alt="Header Avatar">
                    @else
